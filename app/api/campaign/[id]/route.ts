...
export async function GET(
  ...
  try {
    ...
    // Database-level stats (fast groupBy)
    ...
    // Fetch messages — key MUST be "messages" to match frontend interface
    ...
    return NextResponse.json({
      ...campaign,
      stats,
      messages, // ✅ renamed from recentMessages — frontend expects this key
    });
  } catch (err: unknown) {
